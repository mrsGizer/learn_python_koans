...
def test_and_returns_one_of_the_operands():
    """
        Оператор and выполняет булевы операции, но возвращает не булево значение,
        а значение одного из операндов
    """
    r = 'a' and 'b'
...
def test_or_returns_one_of_the_operands():
    """
        Оператор or выполняет булевы операции, но возвращает не булево значение, 
        а значение одного из операндов
    """
    r = 'a' or 'b'
...
def test_or_returns_last_false_operand_if_all_operands_are_false():
    """
        Если все значения оператора or являются ложью, or возвращает последнее
        такое значение
    """
    r = '' or [] or {}
